...
const attractionData = [
    ...
    with the name of all French victories and generals inscribed on its inner and outer surfaces. Under its vault lies the Tomb of the Unknown Soldier from the First World War.`,
    link: 'https://www.toureiffel.paris/en',
    city_id: 7
    },
    {
    ...
    description: `La Cite du Vin is a museum located in the city of Bordeaudx that is a unique cultural venue open to all and dedicated to wine. 
    ...
    The village is located in the heart of the famous Bordeaux wine area. It was named after Emilion,
    a miracle working Benedictine monk who lived in a cave there between AD 750 and 767. 
    ...
    description: `Stroll along the Promenade des Anglais. This is a gorgeous pedestrian area that follows the curve of the Baie des Anges beaches.
     It is a legendary seaside bolouvard is lined with palm tree's and filled with beautiful gardens `,
    ...
    description: `This historic part of Nice feels like a medieval village with narrow streets curving between old buildings with red-tile roofs, small restaurants and open-markets.`,
